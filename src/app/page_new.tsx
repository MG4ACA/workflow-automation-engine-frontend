...
import { logsApi, triggerApi, workflowApi, type LogStats, type Workflow } from '@/services/api';
import {
  CheckCircleIcon,
  ClockIcon,
  PlayIcon,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Welcome to your Workflow Automation Engine. Manage workflows, triggers, and monitor
            executions.
          </p>
        </div>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-700">Simulate a user signup event</p>
                    </div>
                  </div>
